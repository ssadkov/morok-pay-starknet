...
export function classifyTransaction(transaction, options) {
    ...
    const swapsByExecutor = new Map();
    const matchedWithdrawalIndexes = new Set();
    ...
    const selfChannelAggregates = new Map();
    ...
    const isIncoming = actions.some((a) => a.type === "transferReceived") &&
...
//# sourceMappingURL=action-classifier.js.map