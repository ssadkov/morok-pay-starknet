...
export const COMPATIBILITY_POOL_CLASS_HASHES = [
    // SN_SEPOLIA
 ...
 */
export function poolModeForClassHash(classHashFelt) {
    if (classHashFelt === undefined)
...
//# sourceMappingURL=pool-mode.js.map