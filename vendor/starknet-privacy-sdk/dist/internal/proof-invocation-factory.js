...
const DEFAULT_L2_GAS_MAX_AMOUNT = 100000000n;
 ...
 */
export function getDefaultProofDetails(chainId) {
    return {
 ...
 */
export function compileExecuteCalldata(poolAddress, executeViewCalldata) {
 ...
 * Layout: [array_len=1, to, selector, inner_calldata_len, ...inner_calldata]
 */
export function extractExecuteViewCalldata(executeCalldata) {
 ...
 */
export class ProofInvocationFactory {
...
//# sourceMappingURL=proof-invocation-factory.js.map