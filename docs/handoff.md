...
5. Continue the MetaMask Privacy SDK lab from confirmed 1 STRK private balance
   to unshield, private transfer/receipt, and the Sepolia USDC lifecycle. The
   public account, registration, and shield results are recorded in
